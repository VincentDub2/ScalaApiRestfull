...
class ItemRepository @Inject()(implicit ec: ExecutionContext) {
  ...
  private var items: List[Item] = List(
    ...
    Item("20", "Mangue", "10,64 kg CO2e / kg. L'empreinte carbone d'une mangue exportée par avion est élevée en raison de la consommation importante de carburant associée au transport aérien sur de longues distances. Ce mode de transport génère des émissions significatives de gaz à effet de serre. Pour réduire l'empreinte carbone, il est préférable de choisir des fruits cultivés localement et en saison, qui ont tendance à avoir une empreinte carbone moindre. Cela contribue à minimiser l'impact environnemental associé à l'importation de mangues par avion.", +10, "https://res.cloudinary.com/dfkkgyk5w/image/upload/v1701999821/giytewy2lnrna6kwipq7.webp"),
  )
